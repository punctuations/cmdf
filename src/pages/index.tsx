          ...
          <form className="flex flex-col space-y-3">
            ...
            <div className="flex items-center">
              <input
                ...
                className="form-checkbox focus:ring-0 transition-colors duration-150 h-4 w-4 appearance-none checked:text-black checked:hover:text-gray-900 checked:border-transparent border border-gray-300 rounded"
              />
              <label
                htmlFor="emojis"
